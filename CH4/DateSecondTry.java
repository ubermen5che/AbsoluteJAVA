...
public class DateSecondTry {
    ...
    public static void main(String[] args) {
        ...
        DateSecondTry date2 = new DateSecondTry();
        ...
        if (date1.precedes(date2)) {
            System.out.println(date1.getYear() + "-" + date1.getMonth() + "-" + date1.getDay() + " "
                    + "precedes " + date2.getYear() + "-" + date2.getMonth() + "-" + date2.getDay());
        } else
            System.out.println(date2.getYear() + "-" + date2.getMonth() + "-" + date2.getDay() + " "
                    + "precedes " + date1.getYear() + "-" + date1.getMonth() + "-" + date1.getDay());
    ...
    public boolean precedes(DateSecondTry otherDate){
